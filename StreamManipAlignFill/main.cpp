...
int main()
{
    ...
    //Set field width to 10 for all 3 outputs and justifiy all left
    std::cout << "\n--width 10 for num1 and num2 and hello and left for all-----------------------------------------" << std::endl;
    std::cout << std::setw(10) << std::left << num1
                      << std::setw(10) << std::left << num2
                      << std::setw(10) << std::left << hello
                      << std::endl;
                      
    //Setfill to dash - This is persistent
    std::cout << std::setfill('-');
    std::cout <<  "\n--width 10 for num1 and num2 and hello and left for all and setfill to dash-----------" << std::endl;
    ruler();
    std::cout << std::setw(10) << std::left << num1
                      << std::setw(10) << std::left << num2
                      << std::setw(10) << std:: left << hello
